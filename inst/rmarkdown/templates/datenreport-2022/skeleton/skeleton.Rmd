...
```{r metrics, tab.cap = "PLACEHOLDER_TABDie Daten der Lehrberichtserstattung 2021/2022 im Kurzüberblick[^icons]", tab.id = "metrics_tab", ft.align = "left"}
...
[^icons]: Die freien Icons (Pie Line Graph, Team Meeting Message Men, List Numbers, Analytics Bars Horizontal, People Man Graduate) wurden von [https://streamlinehq.com](https://streamlinehq.com) mit einer Attributionslizenz heruntergeladen.
...
## Definitionen zur Kohortenanalyse {#Kohorte}
